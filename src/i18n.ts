...
const EN = {
	...
	"group.animationOrder": "Order",
	"cmd.transition": "Slide transition",
	"cmd.transitionSpeed": "Speed",
	"cmd.transitionDirection": "Direction",
	"cmd.animate": "Add an entrance",
	"cmd.animateTrigger": "Starts",
	"cmd.animationRemove": "Remove from the selected shapes",
	"cmd.animationClear": "Remove every animation on this slide",
	"cmd.animationEarlier": "Play earlier",
	"cmd.animationLater": "Play later",
	"transition.none": "None",
	"transition.fade": "Fade",
	"transition.cut": "Cut",
	"transition.push": "Push",
	"transition.wipe": "Wipe",
	"transition.cover": "Cover",
	"transition.dissolve": "Dissolve",
	"transition.split": "Split",
	"transition.randomBar": "Random bars",
	"speed.slow": "Slow",
	"speed.med": "Medium",
	"speed.fast": "Fast",
	"dir.l": "To the left",
	...
	"effect.wipe": "Wipe",
	"effect.flyIn": "Fly in",
	"effect.other": "Another effect",
	"trigger.click": "On click",
	"trigger.withPrev": "With previous",
	"trigger.afterPrev": "After previous",
	"cmd.find": "Find and replace (Cmd/Ctrl+F)",
	...
	"cmd.crop": "Crop",
	"cmd.cropTooltip": "Crop the picture; drag a handle, then click Crop again to finish",
	"cmd.resetCrop": "Reset the crop to the whole picture",
	...
	"cmd.rulers": "Rulers",
	"cmd.rulersTooltip": "Show rulers; drag out of one to add a guide",
	"cmd.guides": "Guides",
	"cmd.guidesTooltip": "Drawing guides",
	"cmd.addGuideH": "Add a horizontal guide",
	"cmd.addGuideV": "Add a vertical guide",
	"cmd.clearGuides": "Remove all guides",
	"cmd.exportPng": "PNG",
	"cmd.exportPngTooltip": "Export this slide as a PNG",
	"cmd.exportPdf": "PDF",
	"cmd.exportPdfTooltip": "Export every slide as a PDF",
	"cmd.print": "Print",
	"cmd.printTooltip": "Print the deck, or save it as a PDF from the print dialog",
	...
	"pane.collapse": "Fold this section away",
	"pane.expand": "Unfold this section",
	"pane.noSelection": "Select a shape to see what the file says about it.",
	"pane.copyXml": "Copy this shape's XML",
	"pane.copied": "XML copied",
	"prop.id": "Shape id",
	"prop.name": "Name",
	"prop.kind": "Kind",
	"prop.part": "Part",
	...
	"prop.flip": "Flip",
	"prop.hidden": "Hidden",
	"prop.inherited": "No a:xfrm of its own — this frame comes from the layout.",
	"prop.lengthHint": "Pixels, or a number with a unit: emu, pt, in, cm, mm",
	"prop.degreesHint": "Degrees",
	"prop.multiple": "{n} shapes selected",
	"prop.truncated": "(cut off; use the copy button for all of it)",
	"cmd.selectionPane": "Selection",
	"cmd.selectionPaneTooltip": "Every shape on the slide, and what the file says about the selected one",
	...
	"modal.findTitle": "Find and replace",
	"modal.find": "Find",
	"modal.replaceWith": "Replace with",
	"modal.matchCase": "Match case",
	"modal.findAll": "Find all",
	"modal.replaceAll": "Replace all",
	"find.count": "{n} matches",
	"find.none": "No matches",
	"find.replaced": "Replaced {n}",
	"find.skipped": "{n} left as they were: the text runs across a line break or a field",
	...
	"notice.rendering": "Rendering slide {n} of {total}…",
	"notice.printFailed": "Could not print the deck: {message}",
	...
	"notice.extensionTaken":
		"PPTX Studio: another plugin already handles .pptx files. Disable it to use this one.",
...
const JA: Record<StringKey, string> = {
	...
	"group.transition": "画面切り替え",
	"group.animation": "アニメーション",
	"group.animationOrder": "順序",
	"cmd.transition": "画面切り替え",
	"cmd.transitionSpeed": "速度",
	"cmd.transitionDirection": "方向",
	"cmd.animate": "開始アニメーションを付ける",
	"cmd.animateTrigger": "開始のタイミング",
	"cmd.animationRemove": "選択した図形から削除",
	"cmd.animationClear": "このスライドのアニメーションをすべて削除",
	"cmd.animationEarlier": "順序を前へ",
	"cmd.animationLater": "順序を後へ",
	"transition.none": "なし",
	"transition.fade": "フェード",
	"transition.cut": "カット",
	"transition.push": "プッシュ",
	"transition.wipe": "ワイプ",
	"transition.cover": "カバー",
	"transition.dissolve": "ディゾルブ",
	"transition.split": "スプリット",
	"transition.randomBar": "ランダムストライプ",
	"speed.slow": "遅く",
	"speed.med": "標準",
	"speed.fast": "速く",
	"dir.l": "左へ",
	...
	"effect.other": "その他の効果",
	"trigger.click": "クリック時",
	"trigger.withPrev": "直前の動作と同時",
	"trigger.afterPrev": "直前の動作の後",
	"cmd.find": "検索と置換 (Cmd/Ctrl+F)",
	"cmd.delete": "削除 (Del)",
	...
	"cmd.crop": "トリミング",
	"cmd.cropTooltip": "画像をトリミング（ハンドルをドラッグし、もう一度押して確定）",
	"cmd.resetCrop": "トリミングを解除して元の画像に戻す",
	...
	"cmd.rulers": "ルーラー",
	"cmd.rulersTooltip": "ルーラーを表示（ドラッグでガイドを追加）",
	"cmd.guides": "ガイド",
	"cmd.guidesTooltip": "配置ガイド",
	"cmd.addGuideH": "水平ガイドを追加",
	"cmd.addGuideV": "垂直ガイドを追加",
	"cmd.clearGuides": "ガイドをすべて削除",
	"cmd.exportPng": "PNG",
	"cmd.exportPngTooltip": "このスライドを PNG で書き出す",
	"cmd.exportPdf": "PDF",
	"cmd.exportPdfTooltip": "すべてのスライドを PDF で書き出す",
	"cmd.print": "印刷",
	"cmd.printTooltip": "デッキを印刷する（印刷ダイアログから PDF 保存も可能）",
	"cmd.exportMarkdown": "Markdown",
	...
	"pane.hide": "非表示にする",
	"pane.chart": "グラフ",
	"pane.properties": "プロパティ",
	"pane.collapse": "このセクションを折りたたむ",
	"pane.expand": "このセクションを展開する",
	"pane.noSelection": "図形を選択すると、ファイル上の値が表示されます。",
	"pane.copyXml": "この図形の XML をコピー",
	"pane.copied": "XML をコピーしました",
	"prop.id": "図形 ID",
	"prop.name": "名前",
	"prop.kind": "種類",
	"prop.part": "パート",
	"prop.placeholder": "プレースホルダー",
	"prop.rotation": "回転",
	"prop.flip": "反転",
	"prop.hidden": "非表示",
	"prop.inherited": "この図形は a:xfrm を持たず、レイアウトから位置を継承しています。",
	"prop.lengthHint": "px 単位。単位付き（emu, pt, in, cm, mm）でも入力できます",
	"prop.degreesHint": "度",
	"prop.multiple": "{n} 個の図形を選択中",
	"prop.truncated": "（省略されました。全文はコピーボタンから）",
	"cmd.selectionPane": "オブジェクト",
	"cmd.selectionPaneTooltip": "スライド上のオブジェクト一覧と、選択中の図形のプロパティ／XML",
	...
	"modal.insert": "挿入",
	"modal.hyperlink": "リンク",
	"modal.findTitle": "検索と置換",
	"modal.find": "検索する文字列",
	"modal.replaceWith": "置換後の文字列",
	"modal.matchCase": "大文字と小文字を区別する",
	"modal.findAll": "すべて検索",
	"modal.replaceAll": "すべて置換",
	"find.count": "{n} 件",
	"find.none": "見つかりませんでした",
	"find.replaced": "{n} 件置換しました",
	"find.skipped": "{n} 件はそのままです（改行やフィールドをまたいでいます）",
	...
	"notice.rendering": "スライドを描画中 {n}/{total}…",
	"notice.printFailed": "デッキを印刷できませんでした: {message}",
	...
	"notice.extensionTaken":
		"PPTX Studio: 他のプラグインが .pptx を処理しています。そちらを無効にしてください。",
